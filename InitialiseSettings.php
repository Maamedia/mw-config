	...
	*/
	...
	// changes to the default across all overrides --Andrew 2009-04-28
		'default' => [
			...
			'sysop' => [ 'rollbacker', 'editor', 'reviewer', 'confirmed', 'autoreview', 'patroller', 'transwiki', 'ipblock-exempt', 'massmessage-sender' ],
		],
		'+idwiki' => [
			'bureaucrat' => [ 'sysop' ],
		],
	...
	// changes to the default across all overrides --Andrew 2009-04-28
		'default' => [
			...
			'sysop' => [ 'autoreview', 'confirmed', 'patroller', 'transwiki', 'ipblock-exempt', 'massmessage-sender' ]
		],
		'commonswiki' => [
